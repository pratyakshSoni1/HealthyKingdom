package com.pratyaksh.healthykingdom.domain.use_case.get_all_hospitals
...
class GetAllHospitalsUseCase @Inject constructor(private val firebaseRepo: RemoteFirebaseRepo) {
